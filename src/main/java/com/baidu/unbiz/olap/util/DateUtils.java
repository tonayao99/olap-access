...
public class DateUtils {
    ...
    public static FastDateFormat sd1 = FastDateFormat.getInstance("yyyy.MM.dd");
    public static FastDateFormat sd2 = FastDateFormat.getInstance("yyyy.MM.dd HH");
    public static FastDateFormat sd3 = FastDateFormat.getInstance("HH : 00");

    /**
     * 保证Date[0]<Date[1]，并且Date[0]为0时，Date[1]为23时
     */
    public static Date[] ensureDate(Date from, Date to, Date startDate) {
        if (startDate == null) {
        ...
        // 日期约束
        Date noneDataDate = DateUtils.getDate(1986, 6, 25);
        Date start00 = DateUtils.getDate(startYear, startMonth, startDay);
        Date start23 = DateUtils.getDate(startYear, startMonth, startDay, 23);
    ...
    /**
     * 字符串转化wie日期，支持多patten
     * 
     * @param date
     * @param pattern
     * @return 2014-8-4 下午4:13:11 created by wangchongjie
     */
    ...
    /**
     * 获得给定时间的第二天零时的日期对象 例如：若给定时间为（2004-08-01 11:30:58），
    ...
    /**
     * 获得当前时间的第二天零时的日期对象 例如：若当前时间为（2004-08-01 11:30:58），
